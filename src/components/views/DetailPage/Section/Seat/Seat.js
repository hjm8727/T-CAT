...
function Seat() {
    ...
    <div className="seats">
        ...
        <img className="screen" src="images/TCat.jpg" alt=""/>
        </div>

        <h5 className="seat_price">좌석당 8000원</h5>
        <SeatPicker
        ...
        <>
            <div className="seat-price">
                ...
                <h1 className="seats-select">선택한 좌석 : {selected.toString()}</h1>
                </div>
            ...
            <button className="continue" onClick={() => navigate(`/Final/${selected}/${totalprice}`)}>
                계속
            </button>
            </>
        ) : null}
