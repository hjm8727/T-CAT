...
function Login() {
  return (
    ...
    <div className="form-inner">
        <h2>User Login</h2>
        <div className="input-wrapper"><label for="login-username">Username</label>
        ...
        <div className="input-wrapper"><label for="login-password">Password</label>
            <div className="input-group"><span class="icon"><svg viewBox="0 0 24 24">
                    ...
                    </svg></span><input type="password" id="login-password" data-lpignore="true" /></div>
        </div>
